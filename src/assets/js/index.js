...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Donald 'ZebiLa' sin ah cakuat kuat.", "author": "Donald" },
            { "message": "Vapz sinah 'Fly' tiah thawngthanhnak kuat.", "author": "Vapz" },
            { "message": "Ziga na mgbasa ozi 'biMouche'.", "author": "Thémys" }
        ];
